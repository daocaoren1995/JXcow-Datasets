# JXcow-Datasets
JXCow Dataset: RGB–Depth–Point Cloud Cattle Weight Estimation Dataset
1. Dataset Overview
...
Overhead camera is approximately 2.8 m above the ground

Side-view camera is approximately 2.5 m from the corridor center

Sensors: Two Intel RealSense D455 devices, synchronously capturing:

RGB and 16-bit depth
...
Resolution-adaptive intrinsic scaling and pixel-level alignment

Semantic segmentation and background removal

Point cloud reconstruction and pose normalization

This preprocessing improves cross-modal correspondence and standardizes point cloud pose for downstream learning tasks.
